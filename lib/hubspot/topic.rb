module HubspotLegacy
  ...
  class Topic
    ...
    class << self
      ...
      # @return [HubspotLegacy::Topic] array of topics
      def list
        response = HubspotLegacy::Connection.get_json(TOPICS_PATH, {})
      ...
      # @return HubspotLegacy::Topic
      def find_by_topic_id(id)
        response = HubspotLegacy::Connection.get_json(TOPIC_PATH, { topic_id: id })
        new(response)
      end
    end
