describe HubspotLegacy::Connection do
  before do
    HubspotLegacy.configure hapikey: 'fake'
  end
  ...
  describe ".get_json" do
    it "returns the parsed response from the GET request" do
      ...
      result = HubspotLegacy::Connection.get_json(path, {})
  ...
  describe ".post_json" do
    it "returns the parsed response from the POST request" do
      ...
      result = HubspotLegacy::Connection.post_json(path, params: { name: "ABC" })
  ...
  describe ".delete_json" do
    it "returns the response from the DELETE request" do
      ...
      result = HubspotLegacy::Connection.delete_json(path, {})
  ...
  describe ".put_json" do
    it "issues a PUT request and returns the parsed body" do
      ...
      response = HubspotLegacy::Connection.put_json(path, update_options)
    ...
    it "logs information about the request and response" do
      ...
      HubspotLegacy::Connection.put_json(path, update_options)
  ...
  def stub_logger
    instance_double(Logger, info: true).tap do |logger|
      allow(HubspotLegacy::Config).to receive(:logger).and_return(logger)
    end
  end
end
